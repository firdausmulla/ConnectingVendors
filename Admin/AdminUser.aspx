...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="AdminUser.aspx" class="active">
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                <div class="box">
                    <div class="right-side">
                       <div class="box-topic">
                           <asp:Button ID="UpdUser" runat="server" Text="Update" OnClick="UpdUser_Click" CssClass="btn btn-primary" /></div>
                    </div>
                </div>
                <div class="box">
                    <div class="right-side">
                        <div class="box-topic">
                            <asp:Button ID="DelUser" runat="server" Text="Delete" OnClick="DelUser_Click" CssClass="btn btn-primary" />
                        </div>
                    </div>
                </div>
                <div class="box">
                    <div class="right-side">
                        <div class="box-topic">
                        <asp:Button ID="ShowUsers" runat="server" Text="Show" OnClick="ShowUsers_Click" CssClass="btn btn-primary"/></div>
                    </div>
                </div>
            </div>
            <center>
            <div id="updateForm" runat="server" visible="false">
                ...
                <asp:TextBox ID="txtuid" runat="server" Height="24px" Width="163px"></asp:TextBox><br /><br />
                <asp:Label ID="upuname" runat="server" Text="User Name"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtupuname" runat="server" Height="24px" Width="163px"></asp:TextBox><br /><br />
                ...
                <asp:Label ID="upuuname" runat="server" Text="Username"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtuuname" runat="server" Height="24px" Width="163px"></asp:TextBox><br /><br />
        <br />
        <br />
                ...
                <asp:Label ID="deluid" runat="server" Text="User ID"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="home-content">
            <center>
              <div class="sales-details">
                  <asp:GridView ID="GridUsers" runat="server" CssClass="table table-striped table-bordered" Font-Size="Small">
